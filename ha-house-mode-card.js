...
class HAHouseModeCard extends HTMLElement {
  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `<style>
      :host{display:block;--accent:var(--dashboard-accent,#62b5ff);--good:var(--dashboard-success,#54d9aa);--warn:var(--dashboard-warning,#ffbd59);--edge:var(--dashboard-border-neutral,rgba(127,145,165,.2))}
      *{box-sizing:border-box}
      ...
      .mode-tile{display:flex;flex-direction:column;align-items:center;gap:6px;padding:13px 6px;border:1px solid var(--edge);border-radius:14px;background:transparent;color:var(--primary-text-color);cursor:pointer;text-align:center}
      .mode-tile:hover{border-color:var(--primary-text-color)}
      .mode-tile.active{border-color:var(--good);background:color-mix(in srgb,var(--good) 10%,transparent)}
      ...
      .row{display:flex;align-items:center;gap:10px;padding:11px 12px;border:1px solid var(--edge);border-radius:14px;cursor:pointer}
      ...
      .ov-tile{display:flex;flex-direction:column;align-items:center;gap:5px;padding:10px 6px;border:1px solid var(--edge);border-radius:13px;background:transparent;color:var(--primary-text-color);cursor:pointer}
      .ov-tile.on{border-color:var(--warn);background:color-mix(in srgb,var(--warn) 12%,transparent)}
